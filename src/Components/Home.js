...
class Home extends Component {
  ...
  handdleLoadMore = () => this.fetchMovies(this.state.movies.page + 1, this.state.searchTerm);
  ...
  render() {
    ...
    return (
      <>
        ...
        <Grid header={searchTerm ? 'Searched movies' : 'Popular Movies'}>
        ...
        {loading && <Spinner />}
        {movies.page < movies.total_pages && !loading && <Button text='Load More' callback={this.handdleLoadMore} />}
        <Footer />
      </>
    );
  }
